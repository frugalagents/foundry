    ...
    *,
    ...
    return {
        **_architecture_revision_key(
        ...
        "component_intents": dict(component_intents or {}),
        "offering_selections": dict(offering_selections or {}),
        "override_requests": list(override_requests or []),
        "accepted_proposals": list(accepted_proposals or []),
    ...
    *,
    ...
    if int(item["persistence_revision"]) == 1:
        revision = _architecture_revision_item(
            ...
            component_intents=item.get("component_intents"),
            offering_selections=item.get("offering_selections"),
            override_requests=item.get("override_requests"),
            accepted_proposals=item.get("accepted_proposals"),
...
def update_architecture_workspace_state(
    *,
    ...
    revision = _architecture_revision_item(
        ...
        offering_selections=offering_selections,
